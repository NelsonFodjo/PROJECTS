    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 py-24 md:py-36 relative z-10">
        <motion.div
          ...
          className="max-w-xl"
        >
          <span className="inline-block bg-lime text-ink font-display text-sm px-4 py-1.5 rounded-full">
            August 9, 2026
          </span>

          <h1 className="font-display text-white text-4xl sm:text-6xl mt-5 leading-tight">
            AYD with KcBlendz
          </h1>
          <p className="font-display text-lime text-2xl sm:text-3xl mt-2">Are You Done?</p>
          ...
          <motion.button
            ...
            className="font-display mt-7 bg-lime text-ink rounded-lg px-6 h-11 inline-flex items-center shadow-soft"
          >
            Register Now &rarr;
          </motion.button>
